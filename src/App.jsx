...
import MeterChart from "./pages/detail-pages/AllReadIndexesDetailPage";
import AllReadIndexesDetailPage from "./pages/detail-pages/AllReadIndexesDetailPage";
